...
public class MessageListener {
    ...
    /**
     * Handles incoming OrderPlacedEvents.Using the conditional
     * {@link StreamListener} from
     ...
     * in a way close to what Axion would do (see
     * e.g.https://dturanski.wordpress.com/2017/03/26/spring-cloud-stream-for-event-driven-architectures/)
     *
     * @param message
    ...
    /**
     * Very generic listener for simplicity. It takes all events and checks, if
     * a flow instance is interested. If yes, they are correlated, otherwise
     * they are just discarded.
     *
     * It might make more sense to handle each and every message type
     * individually.
     */
    @StreamListener(target = Sink.INPUT,
